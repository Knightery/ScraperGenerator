...
URL: https://careers.wipfli.com/all-openings?size=n_10_n
Generated at: 2025-10-05T18:43:58.849656
"""
...
def get_scraper_config():
    ...
    return {
        ...
        'scrape_url': 'https://careers.wipfli.com/all-openings?size=n_10_n',
        'job_container_selector': 'li.sui-result',
        'title_selector': 'h3 a',
        'url_selector': 'h3 a',
        'description_selector': '',
        'location_selector': 'div.MuiBox-root.css-1ic066d span.MuiChip-label',
        'requirements_selector': '',
        'pagination_selector': 'nav[aria-label="pagination navigation"] button[aria-label="Go to next page"]',
        'has_dynamic_loading': False,
        'search_required': True,
        'search_input_selector': '',
        'search_submit_selector': 'div[role="button"]:has(span:text-is("Internships"))',
        'search_query': '',
        'text_filter_keywords': 'intern,internship,co-op',
...
def main():
    ...
    if jobs:
        ...
        print(f"URL: 'https://careers.wipfli.com/all-openings?size=n_10_n'")
