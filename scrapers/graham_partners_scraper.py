...
URL: https://www.grahampartners.net/careers/#internship
Generated at: 2025-10-02T10:55:47.820087
"""
...
def get_scraper_config():
    ...
    return {
        ...
        'scrape_url': 'https://www.grahampartners.net/careers/#internship',
        'job_container_selector': 'div.single-card.active[data-career_type=".internship."]',
        'title_selector': '.inner > span.cell',
        'url_selector': '.hover-inner > a.read-more',
        ...
        'search_submit_selector': 'button[data-term="internship"]',
        'search_query': '',
...
def main():
    ...
    if jobs:
        ...
        print(f"URL: 'https://www.grahampartners.net/careers/#internship'")
