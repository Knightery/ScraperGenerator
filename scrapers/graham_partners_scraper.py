...
URL: https://grahampartners.applicantpro.com/jobs/
Generated at: 2025-10-04T21:56:01.397575
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/graham_partners_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        'company_name': 'graham partners',
        'scrape_url': 'https://grahampartners.applicantpro.com/jobs/',
        'job_container_selector': 'div#job_results > div.bdb1',
        'title_selector': 'a.job-name.listing-url',
        'url_selector': 'a.job-name.listing-url',
        'description_selector': '',
        'location_selector': 'div.w-card__content > div > div > div:nth-child(1) > div > span',
        'requirements_selector': '',
        'pagination_selector': '',
        'has_dynamic_loading': True,
        'search_required': True,
        'search_input_selector': 'input#keywords',
        'search_submit_selector': '',
        'search_query': 'Internship',
        'text_filter_keywords': 'intern,summer,analyst,co-op',
...
def main():
    ...
    logger.info("Starting graham partners job scraper...")
    ...
    company = db_manager.get_company_by_name('graham partners')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'graham partners'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'graham partners'")
        print(f"URL: 'https://grahampartners.applicantpro.com/jobs/'")
