...
URL: https://ashtonfire.com/careers/
Generated at: 2025-10-07T16:10:44.709692
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/ashton_fire_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        'company_name': 'Ashton Fire',
        'scrape_url': 'https://ashtonfire.com/careers/',
...
def main():
    ...
    logger.info("Starting Ashton Fire job scraper...")
    ...
    company = db_manager.get_company_by_name('Ashton Fire')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'Ashton Fire'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'Ashton Fire'")
        print(f"URL: 'https://ashtonfire.com/careers/'")
