...
URL: https://www.nbcunicareers.com/internships
Generated at: 2025-10-11T15:01:09.691378
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/nbcuniversal_monitor.log'),
...
def get_monitor_config():
    ...
    return {
        ...
        'scrape_url': 'https://www.nbcunicareers.com/internships',
...
def main():
    ...
    logger.info("Starting NBCUniversal monitor scraper...")
    
    config = get_monitor_config()
    db_manager = SupabaseDatabaseManager()
    
    # Get company info from database
    company = db_manager.get_company_by_name('NBCUniversal')
    if not company:
    ...
    if not previous_snapshot:
        ...
        print(f"Company: 'NBCUniversal'")
        print(f"URL: 'https://www.nbcunicareers.com/internships'")
