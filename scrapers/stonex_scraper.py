...
URL: https://www.stonex.com/en/about/careers/jobs/?positionTypes=Intern
Generated at: 2025-10-06T22:12:07.618572
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/stonex_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        'company_name': 'StoneX',
        'scrape_url': 'https://www.stonex.com/en/about/careers/jobs/?positionTypes=Intern',
        'job_container_selector': '.careers-module__card',
        'title_selector': '.careers-module__card-title',
        'url_selector': '.careers-module__card-title',
        'description_selector': '.careers-module__card-description',
        'location_selector': '.careers-module__card-location span:first-of-type',
        'requirements_selector': '',
        'pagination_selector': '.careers-module-listings__next-btn',
...
def main():
    ...
    logger.info("Starting StoneX job scraper...")
    ...
    company = db_manager.get_company_by_name('StoneX')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'StoneX'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'StoneX'")
        print(f"URL: 'https://www.stonex.com/en/about/careers/jobs/?positionTypes=Intern'")
