...
URL: https://www.kpmguscareers.com/job-search/?career-level=Internship%7C&career-level-parents=&spage=1
Generated at: 2025-10-04T21:13:22.974507
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/kpmg_united_states_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        'company_name': 'KPMG united states',
        'scrape_url': 'https://www.kpmguscareers.com/job-search/?career-level=Internship%7C&career-level-parents=&spage=1',
        'job_container_selector': '.search--item',
        'title_selector': '.list-view .h5',
        'url_selector': 'a',
        'description_selector': '',
        'location_selector': '.list-view .text-xs',
...
def main():
    ...
    logger.info("Starting KPMG united states job scraper...")
    ...
    company = db_manager.get_company_by_name('KPMG united states')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'KPMG united states'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'KPMG united states'")
        print(f"URL: 'https://www.kpmguscareers.com/job-search/?career-level=Internship%7C&career-level-parents=&spage=1'")
