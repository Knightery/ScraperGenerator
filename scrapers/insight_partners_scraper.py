...
URL: https://www.insightpartners.com/join-insight/
Generated at: 2025-10-11T14:56:39.468927
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/insight_partners_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        ...
        'scrape_url': 'https://www.insightpartners.com/join-insight/',
        'job_container_selector': 'div.wysiwyg-content-wrapper > h5[style*="color: #ff531b"]',
...
def main():
    ...
    logger.info("Starting Insight Partners job scraper...")
    ...
    company = db_manager.get_company_by_name('Insight Partners')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'Insight Partners'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'Insight Partners'")
        print(f"URL: 'https://www.insightpartners.com/join-insight/'")
