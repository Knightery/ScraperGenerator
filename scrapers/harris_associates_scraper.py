...
URL: https://job-boards.greenhouse.io/harrisassociates
Generated at: 2025-10-02T10:52:40.209485
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/harris_associates_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        'company_name': 'Harris Associates',
        'scrape_url': 'https://job-boards.greenhouse.io/harrisassociates',
        'job_container_selector': 'tr.job-post',
        'title_selector': 'td.cell a p.body--medium',
        'url_selector': 'td.cell a',
        'description_selector': '',
        'location_selector': 'td.cell a p.body__secondary',
        'requirements_selector': '',
        'pagination_selector': '',
        'has_dynamic_loading': False,
        'search_required': True,
        'search_input_selector': 'input#keyword-filter',
        'search_submit_selector': '',
        'search_query': 'internship',
        'text_filter_keywords': 'intern,summer,co-op',
...
def main():
    ...
    logger.info("Starting Harris Associates job scraper...")
    ...
    company = db_manager.get_company_by_name('Harris Associates')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'Harris Associates'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'Harris Associates'")
        print(f"URL: 'https://job-boards.greenhouse.io/harrisassociates'")
