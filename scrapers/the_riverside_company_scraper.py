...
URL: https://www.riversidecompany.com/jobs/
Generated at: 2025-10-04T21:17:59.903184
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/the_riverside_company_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        'company_name': 'the riverside company',
        'scrape_url': 'https://www.riversidecompany.com/jobs/',
        'job_container_selector': '.job-post',
        'title_selector': 'h2.position-name',
        'url_selector': '',
        'description_selector': '',
        'location_selector': 'h3.position-location',
...
def main():
    ...
    logger.info("Starting the riverside company job scraper...")
    ...
    company = db_manager.get_company_by_name('the riverside company')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'the riverside company'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'the riverside company'")
        print(f"URL: 'https://www.riversidecompany.com/jobs/'")
