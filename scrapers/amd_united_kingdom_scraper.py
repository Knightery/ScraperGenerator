...
URL: https://careers.amd.com/jobs?page=1&categories=Student%20%2F%20Intern%20%2F%20Temp
Generated at: 2025-10-06T12:00:24.860570
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(f'logs/amd_united_kingdom_scraper.log'),
...
def get_scraper_config():
    ...
    return {
        'company_name': 'AMD United Kingdom',
        'scrape_url': 'https://careers.amd.com/jobs?page=1&categories=Student%20%2F%20Intern%20%2F%20Temp',
        'job_container_selector': 'mat-expansion-panel.search-result-item',
        'title_selector': 'mat-panel-title .job-title-link span[itemprop="title"]',
        'url_selector': 'mat-panel-title .job-title-link',
        'description_selector': '',
        'location_selector': 'mat-panel-description .label-value.location',
...
def main():
    ...
    logger.info("Starting AMD United Kingdom job scraper...")
    ...
    company = db_manager.get_company_by_name('AMD United Kingdom')
    if not company:
    ...
    if jobs:
        logger.info(f"Successfully scraped {len(jobs)} jobs from 'AMD United Kingdom'")
        
        # Print summary
        print(f"\\n=== SCRAPING RESULTS ===")
        print(f"Company: 'AMD United Kingdom'")
        print(f"URL: 'https://careers.amd.com/jobs?page=1&categories=Student%20%2F%20Intern%20%2F%20Temp'")
